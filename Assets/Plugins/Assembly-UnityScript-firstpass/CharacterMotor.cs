...
{
	[Serializable]
	internal sealed class _0024SubtractNewPlatformVelocity_002458 : GenericGenerator<object>
	{
		[Serializable]
		internal sealed class _0024 : GenericGeneratorEnumerator<object>, IEnumerator
		{
			internal Transform _0024platform_002459;

			internal CharacterMotor _0024self__002460;

			public _0024(CharacterMotor self_)
			{
				_0024self__002460 = self_;
			}
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (_0024self__002460.movingPlatform.enabled && (_0024self__002460.movingPlatform.movementTransfer == MovementTransferOnJump.InitTransfer || _0024self__002460.movingPlatform.movementTransfer == MovementTransferOnJump.PermaTransfer))
					{
						if (_0024self__002460.movingPlatform.newPlatform)
						{
							_0024platform_002459 = _0024self__002460.movingPlatform.activePlatform;
				...
				case 2:
					...
					break;
				case 3:
					if (_0024self__002460.grounded && _0024platform_002459 == _0024self__002460.movingPlatform.activePlatform)
					{
					...
					goto case 4;
				case 4:
					_0024self__002460.movement.velocity = _0024self__002460.movement.velocity - _0024self__002460.movingPlatform.platformVelocity;
					goto IL_0124;
				case 1:
					{
						result = 0;
		...
		public _0024SubtractNewPlatformVelocity_002458(CharacterMotor self_)
		{
		...
		{
			return new _0024(_0024self__002461);
		}
	}
	...
	{
		if ((bool)GameObject.FindGameObjectWithTag("disablecollider"))
		{
			int num = 0;
		}
		else
		...
		if ((bool)GameObject.FindGameObjectWithTag("jumpheight"))
		{
			float num2 = float.Parse(GameObject.FindGameObjectWithTag("jumpheight").name);
			float num3 = float.Parse(GameObject.FindGameObjectWithTag("jumpheight").name);
		}
		if (!useFixedUpdate)
		{
			UpdateFunction();
	...
	{
		return new _0024SubtractNewPlatformVelocity_002458(this).GetEnumerator();
	}
