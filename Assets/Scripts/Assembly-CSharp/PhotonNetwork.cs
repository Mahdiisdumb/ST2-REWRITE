...
public static class PhotonNetwork
{
	...
	public static bool ConnectUsingSettings(string gameVersion)
	{
		...
		if (PlayerPrefs.GetInt("customserver") == 0)
		{
			networkingPeer.SetApp(PlayerPrefs.GetString("appid"), gameVersion);
		}
		else
		{
			networkingPeer.SetApp(PlayerPrefs.GetString("id"), gameVersion);
		}
