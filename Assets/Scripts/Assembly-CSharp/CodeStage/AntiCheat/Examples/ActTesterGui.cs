...
namespace CodeStage.AntiCheat.Examples
{
	...
	{
		[CompilerGenerated]
		private sealed class _003CGetAllSimpleObscuredTypes_003Ec__AnonStorey0
		{
			internal string types;

			internal void _003C_003Em__0(Type t)
			{
				if (types.Length > 0)
				{
					types = types + "\n" + t.Name;
		...
		[CompilerGenerated]
		private static Func<Assembly, bool> _003C_003Ef__am_0024cache0;

		[CompilerGenerated]
		private static Func<Type, bool> _003C_003Ef__am_0024cache1;
		...
		{
			_003CGetAllSimpleObscuredTypes_003Ec__AnonStorey0 _003CGetAllSimpleObscuredTypes_003Ec__AnonStorey = new _003CGetAllSimpleObscuredTypes_003Ec__AnonStorey0();
			string result = "Can't use reflection here, sorry :(";
			_003CGetAllSimpleObscuredTypes_003Ec__AnonStorey.types = string.Empty;
			if (string.IsNullOrEmpty(allSimpleObscuredTypes))
			{
				Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies();
				if (_003C_003Ef__am_0024cache0 == null)
				{
					_003C_003Ef__am_0024cache0 = _003CGetAllSimpleObscuredTypes_003Em__0;
				}
				Assembly assembly = assemblies.SingleOrDefault(_003C_003Ef__am_0024cache0);
				if (assembly != null)
				{
					Type[] types = assembly.GetTypes();
					if (_003C_003Ef__am_0024cache1 == null)
					{
						_003C_003Ef__am_0024cache1 = _003CGetAllSimpleObscuredTypes_003Em__1;
					}
					IEnumerable<Type> source = types.Where(_003C_003Ef__am_0024cache1);
					source.ToList().ForEach(_003CGetAllSimpleObscuredTypes_003Ec__AnonStorey._003C_003Em__0);
					if (!string.IsNullOrEmpty(_003CGetAllSimpleObscuredTypes_003Ec__AnonStorey.types))
					{
						result = _003CGetAllSimpleObscuredTypes_003Ec__AnonStorey.types;
						allSimpleObscuredTypes = _003CGetAllSimpleObscuredTypes_003Ec__AnonStorey.types;
					}
				}
			}
			else
		...
		private void LoadObscuredPrefs()
		{
			...
			text = obscuredPrefs;
			obscuredPrefs = text + "bool: " + ObscuredPrefs.GetBool("gameComplete", false) + "\n";
			text = obscuredPrefs;
		...
		[CompilerGenerated]
		private static bool _003CGetAllSimpleObscuredTypes_003Em__0(Assembly assembly)
		{
			return assembly.GetName().Name == "Assembly-CSharp";
		}

		[CompilerGenerated]
		private static bool _003CGetAllSimpleObscuredTypes_003Em__1(Type t)
		{
